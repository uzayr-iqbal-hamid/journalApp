...
import com.uzayr.journalApp.service.JournalEntryService;
...
public class JournalEntryController {
    ...
    // to fetch all the journals for a user
    @GetMapping
    ...
    // to create a new journal by a particular user
    @PostMapping
    ...
    // fetch a journal by passing its ID
    @GetMapping("id/{myId}")
